...
public class SeedFill4<P> implements SeedFill<P> {
    ...
    public void fillPatern(@NotNull RasterImage<P> img, int x, int y,  // Nefunguje, whatever
        ...
        img.getPixel(x, y+5).equals(BGColour) &&
                img.getPixel(x, y+6).equals(BGColour) &&
                img.getPixel(x, y+7).equals(BGColour) &&
                img.getPixel(x, y+8).equals(BGColour) &&
                img.getPixel(x, y+9).equals(BGColour) &&
                ...
                img.getPixel(x+1, y).equals(BGColour) &&
                img.getPixel(x+1, y).equals(BGColour))
            fillPatern(img, x, y + 5, pixelValue,pixelValue2, BGColour);
